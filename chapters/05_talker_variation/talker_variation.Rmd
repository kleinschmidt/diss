...
<!-- TODO --> (( still not quite sure about this. needs to be punched up
especially since it's one of the main focuses of the special issue ))
...
* __Dialect__: the NSP contains data from talkers from six dialect regions (see
  below for details).
* __Diaelct+Sex__: @Clopper2005 found that sex modulates dialect differences, so
  we also examing cue distributions conditioned on dialect and sex together (12
  levels, vowels only).
