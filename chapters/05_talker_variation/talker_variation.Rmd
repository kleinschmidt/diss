...
Applied to speech perception, these approaches reveal two important things.
These approaches suggest that speech perception is a process of _inference under
uncertainty_: because of noise in production processes, each linguistic unit is
realized---even by a single talker---as a _distribution_ of acoustic cues [cf. @Lisker1964; @Peterson1952; @Hillenbrand1995; @Allen2001; @Newman2001]. As
