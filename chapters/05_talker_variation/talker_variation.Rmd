...
Conditioning cue distribution on sex---either alone, relative to marginal, or in
addition to dialect---provides the biggest boost in recognition for
...
`r dialect_avg_advantage %$% round(observed*100)`% on average, all $`r
dialect_avg_advantage %$% p_val_to_less_than(boot_p)`$).
