...
Most of the work on the relationship between socio-indexical and linguistic
variables has been descriptive [but not all, e.g., @Clopper2005]. In the current
study, we aim to use the theoretical and computational tools of the ideal
adapter framework to quantify this relationship for a number of these
...
<!-- does some of this belong in background? -->
