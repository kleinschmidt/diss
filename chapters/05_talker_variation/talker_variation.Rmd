...
perception, both of which can be seen as processes of _inference_ that rely on
the same basic knowledge about the cue distributions that correspond to
different underlying lingiustic and social variables.
