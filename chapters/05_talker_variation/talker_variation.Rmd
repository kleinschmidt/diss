...
[^vs-marginal-or-other]: @Richter2016 apply a similar approach to vowel data
    ...
    socio-indexical variables are about the underlying distributions. Our goals
    are thus related but not identical
    <!-- TODO-paper: spell out in text -->
...
instance, as we have seen, overall vowels vary substantially more across talkers than
...
[^gen-vs-discrim]: Our approach is based on a _generative_ model of
    ...
    that @McMurray2011a used to evaluate the utility of different cue encoding
    ...
    those of the discriminative modeling approach of @McMurray2011a.
...
comprehending speech from an unfamiliar talker. 
<!-- 
...
of flexibility depends on the _cue_ (or phonetic feature, like $\pm \mathrm{voicing}$) rather than the _category_ specifically, in
...
just recognizing phonetic categories [or linguistic representations at any particular level, cf. @Kuperberg2016]. Sociolinguistics recognizes that, in many
...
socio-indexical variables do not always seem to be based on _objective_ informativity of
...
[@Eckert2012; @Podesva2001; @Podesva2007; @Foulkes2015a; @Levon2014; @Jaeger2016].
...
nothing to do with accurate speech recognition per se [for similar points, see @Babel2014; @Pardo2006; @Foulkes2015a; @Eckert2012; @Labov1972]. To the extent that a
...
and to observable cues [for examples of similar blocking effects in other domains, see @Jacobs2010; and in speech perception, see @Kraljic2008a; @Kraljic2011; @LiuInPrep2016]. Such
