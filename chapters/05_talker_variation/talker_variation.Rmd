...
* (( PROBABLY TOO MUCH FOR THIS PAPER )) if this is true, what does this
  perspective contribute above and beyond "traditional" socioliguistics?
    * (quantifiable) notions of cue reliability. WHY some judgements block
      others, and which.
    * for instance, if cues to gayness fall closer to normal range of variation may be easier to explain away than cues to class; prior belief that you can't be both gay and working class blocks the normal inference about gayness.
