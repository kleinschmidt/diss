...
One thing that these results reveal is that socio-linguistic judgements
can---like linguistic judgements---be viewed as probabilistic inference. In this
view, both social and linguistic judgements rely on knowledge of how different
underlying categories---social and linguistic---are probabilistically realized
as distributions of observable cues. Just like each vowel (for instance) is
...
_explains_ the speech they've observed.  We find that this kind of
model can classify a talker's dialect at roughly the same accuracy (10-40%) as
human listeners in a forced-choice task based on sentences spoken by the same talkers [@Clopper2006].
