...
`r north_adv_lob %>% filter(str_detect(comparison, 'marg')) %>% format_advantage()`,
and over sex-specific for raw formants, increasing accuracy by 
`r north_adv_raw %>% filter(str_detect(comparison, 'sex')) %>% format_advantage()`.
...
(`r midatl_adv_lob %>% filter(str_detect(comparison, 'marg')) %>% format_advantage(paren=FALSE)`)
and raw input
(`r midatl_adv_raw %>% filter(str_detect(comparison, 'marg')) %>% format_advantage(paren=FALSE)`).[^logodds]
