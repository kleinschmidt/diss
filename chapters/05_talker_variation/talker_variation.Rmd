...
depend on the particular cues, category, or socio-indexical variable?  Our
second study addresses this question, using the ideal adapter's link between cue
distributions and phonetic categorization.
...
socio-indexical properties based on phonetic cue distributions alone.


<!-- ------------------------------------------- -->

Finally, this work has implications beyond simply connecting sociolinguistic and
psycholinguistic perspectives on variability in speech perception.  The ideal
...
variables, and cue distributions.  Thus the results of the current work open the
door to new lines of empirical work on speech perception.
...
<!-- TODO/WIP: I feel like this can be merged with the background bits. what we know and don't know motivates our choice of data, and our choice of methods. and BOTH of these can be integrated with the goals. -->

We selected data to include in this study on the basis of three criteria. First, we want to compare the role of socio-indexical grouping _across_ phonetic categories/cues, and thus we sought corpora for cues/categories that are thought to have qualitatively different degrees of talker variability. Second, <!-- enough tokens per talker/category --> 
Third, <!-- enough talkers, with socio-indexical variables annotated -->



With these criteria in mind, we selected two corpora, one focusing on vowels and
the other on stop consonant voicing. One goal of this paper is to compare the
informativity and utility of socio-indexical grouping variables _between_
different phonetic contrasts and cues. Our selection of datasets is guided by
this goal. Stop voicing (cued by voice onset time; VOT) and vowel identity (cued
by formant frequencies) exhibit different patterns of talker variability in
American English. Vowels differ substantially across talkers, and have
systematic differences due to gender [@Peterson1952; @Hillenbrand1995] and
dialect [@Clopper2005]. Stop consonant voicing exhibits _some_ talker
variability, but little systematic variation by dialect or sex
[@Allen2003; @Lisker1964; @Chodroff2015]. Thus, we expect that VOT will provide
an approximate lower bound, and vowel formants an approximate upper bound, on
the informativity and utility of socio-indexical variables.

<!--  -->


Thus, we expect that comparing them will provide a good estimate of the range of
