...
Of course, there are other possible explanations for the lack of large shifts in these conditions. 
...
<!-- evidence for prevoicing? would expect _smaller_ (relative to model fits) shifts for negative VOT /p/ dists than high /p/ dists. well I mean we DO find that, just not _relative to model predictions_. -->
