...
who produced an _un_correlated distribution, where f0 is uninformative. Listeners in this condition also adapted, learning to ignore f0 even for ambiguous
VOTs. But when exposed in a third condition to a talker who produced an _anti_correlated
