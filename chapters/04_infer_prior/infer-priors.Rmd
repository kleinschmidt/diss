...
predict that prior experience _constraints_ (or _guides_) learning and
...
listener encounters a talker whose accent lies outside the range that they think
is _a priori_ plausible based on their prior experience, they will have a hard
time adapting to that talker.
